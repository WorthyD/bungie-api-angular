...
export class TrendingService {
     ...
     */
    public trendingGetTrendingCategories(observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20062>;
    public trendingGetTrendingCategories(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20062>>;
    public trendingGetTrendingCategories(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20062>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public trendingGetTrendingCategory(categoryId: string, pageNumber: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20063>;
    public trendingGetTrendingCategory(categoryId: string, pageNumber: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20063>>;
    public trendingGetTrendingCategory(categoryId: string, pageNumber: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20063>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public trendingGetTrendingEntryDetail(identifier: string, trendingEntryType: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20064>;
    public trendingGetTrendingEntryDetail(identifier: string, trendingEntryType: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20064>>;
    public trendingGetTrendingEntryDetail(identifier: string, trendingEntryType: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20064>>;
