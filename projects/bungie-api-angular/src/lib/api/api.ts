...
export const APIS = [DefaultService, AppService, CommunityContentService, ContentService, Destiny2Service, FireteamService, ForumService, GroupV2Service, PreviewService, TokensService, TrendingService, UserService];
