...
export class ForumService {
  ...
  public forumGetCoreTopicsPaged(
    ...
    if (locales !== undefined && locales !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>locales, 'locales');
    }
    ...
    return this.httpClient.get<InlineResponse20011>(
      `${this.configuration.basePath}/Forum/GetCoreTopicsPaged/${encodeURIComponent(String(page))}/${encodeURIComponent(
        String(sort)
      )}/${encodeURIComponent(String(quickDate))}/${encodeURIComponent(String(categoryFilter))}/`,
      {
  ...
  public forumGetForumTagSuggestions(
    ...
    if (partialtag !== undefined && partialtag !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>partialtag, 'partialtag');
    }
  ...
  public forumGetPoll(
    ...
    return this.httpClient.get<InlineResponse20011>(
      `${this.configuration.basePath}/Forum/Poll/${encodeURIComponent(String(topicId))}/`,
      {
        responseType: <any>responseType,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public forumGetPostAndParent(
    ...
    if (showbanned !== undefined && showbanned !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>showbanned, 'showbanned');
    }
    ...
    return this.httpClient.get<InlineResponse20011>(
      `${this.configuration.basePath}/Forum/GetPostAndParent/${encodeURIComponent(String(childPostId))}/`,
      {
        params: queryParameters,
        responseType: <any>responseType,
        withCredentials: this.configuration.withCredentials,
  ...
  public forumGetPostAndParentAwaitingApproval(
    ...
    return this.httpClient.get<InlineResponse20011>(
      `${this.configuration.basePath}/Forum/GetPostAndParentAwaitingApproval/${encodeURIComponent(
        String(childPostId)
      )}/`,
      {
        params: queryParameters,
  ...
  public forumGetPostsThreadedPaged(
    ...
    return this.httpClient.get<InlineResponse20011>(
      `${this.configuration.basePath}/Forum/GetPostsThreadedPaged/${encodeURIComponent(
        String(parentPostId)
      )}/${encodeURIComponent(String(page))}/${encodeURIComponent(String(pageSize))}/${encodeURIComponent(
        String(replySize)
      )}/${encodeURIComponent(String(getParentPost))}/${encodeURIComponent(
  ...
  public forumGetPostsThreadedPagedFromChild(
    ...
    return this.httpClient.get<InlineResponse20011>(
      `${this.configuration.basePath}/Forum/GetPostsThreadedPagedFromChild/${encodeURIComponent(
        String(childPostId)
      )}/${encodeURIComponent(String(page))}/${encodeURIComponent(String(pageSize))}/${encodeURIComponent(
        String(replySize)
      )}/${encodeURIComponent(String(rootThreadMode))}/${encodeURIComponent(String(sortMode))}/`,
      {
        params: queryParameters,
        responseType: <any>responseType,
        withCredentials: this.configuration.withCredentials,
  ...
  public forumGetRecruitmentThreadSummaries(
    ...
    return this.httpClient.post<InlineResponse20014>(`${this.configuration.basePath}/Forum/Recruit/Summaries/`, null, {
      responseType: <any>responseType,
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
  ...
  public forumGetTopicForContent(
    ...
    return this.httpClient.get<InlineResponse20012>(
      `${this.configuration.basePath}/Forum/GetTopicForContent/${encodeURIComponent(String(contentId))}/`,
      {
        responseType: <any>responseType,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public forumGetTopicsPaged(
    ...
    if (tagstring !== undefined && tagstring !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>tagstring, 'tagstring');
    }
    ...
    return this.httpClient.get<InlineResponse20011>(
      `${this.configuration.basePath}/Forum/GetTopicsPaged/${encodeURIComponent(String(page))}/${encodeURIComponent(
        String(pageSize)
      )}/${encodeURIComponent(String(group))}/${encodeURIComponent(String(sort))}/${encodeURIComponent(
        String(quickDate)
