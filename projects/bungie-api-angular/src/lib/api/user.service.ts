...
export class UserService {
  ...
  public userGetBungieNetUserById(
    ...
    return this.httpClient.get<InlineResponse2002>(
      `${this.configuration.basePath}/User/GetBungieNetUserById/${encodeURIComponent(String(id))}/`,
      {
        responseType: <any>responseType,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public userGetCredentialTypesForTargetAccount(
    ...
    return this.httpClient.get<InlineResponse2003>(
      `${this.configuration.basePath}/User/GetCredentialTypesForTargetAccount/${encodeURIComponent(
        String(membershipId)
      )}/`,
      {
        responseType: <any>responseType,
  ...
  public userGetMembershipDataById(
    ...
    return this.httpClient.get<InlineResponse2005>(
      `${this.configuration.basePath}/User/GetMembershipsById/${encodeURIComponent(
        String(membershipId)
  ...
  public userGetMembershipFromHardLinkedCredential(
    ...
    return this.httpClient.get<InlineResponse2006>(
      `${this.configuration.basePath}/User/GetMembershipFromHardLinkedCredential/${encodeURIComponent(
        String(crType)
